...
<div class="columns fixed-page edit">
  <div class="column main-column">
    ...
    <div class="flexrow infos">
      <div class="flexrow-item">
      <page-subtitle :text="$t('entities.tasks')" />
      <entity-task-list
        class="task-list"
        :entries="currentTasks.map(t => t.id)"
        :is-loading="!currentEntity"
        :is-error="false"
      ...
      <div class="flexrow-item">
        ...
        <div class="table-body">
          <table class="datatable" v-if="currentEntity">
            <tbody class="datatable-body">
              <tr
                class="datatable-row"
              >
                <td class="field-label">{{ $t('entities.fields.description') }}</td>
                <description-cell
                  :entry="currentEntity"
                  :full="true"
                />
              ...
              >
                ...
                <td>
                  {{ currentEntity.data ? currentEntity.data[descriptor.field_name] : '' }}
                </td>
              </tr>
  ...
  <edit-entity-modal
    ref="edit-entity-modal"
    :active="modals.edit"
    :is-loading="loading.edit"
    :is-error="errors.edit"
    :edit-to-edit="currentEntity"
...
export default {
  ...
  computed: {
    ...
    title () {
      if (this.currentEntity) {
        if (this.currentEntity.episode_name) {
          return `${this.currentEntity.episode_name} / ` +
  ...
  methods: {
    ...
    confirmEditEntity (form) {
      form.id = this.currentEntity.id
      this.loading.edit = true
      this.errors.edit = false
      this.editEntity(form)
        .then(() => {
